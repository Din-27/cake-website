...
const ProductDetails = ({ params }) => {
  ...
  const { handleClose, isOpen }: any = useContext(SidebarContext);
  ...
  return (
    <section style={isOpen ? { 'overflow': 'hidden' } : {}} className="pt-[450px] md:pt-32 pb-[400px] md:pb-12 lg:py-32 h-screen flex items-center" onClick={handleClose}>
